...
<div class="spark-screen add-page">
	...
	<div class="row">
		...
		{!! Form::open( array( 'route'=> 'admin.collegetab.store','files' => true,'accept-charset'=>'UTF-8','method'=>'POST', 'class'=>'form-horizontal' ) ) !!}
		<!-- start of main-content -->
		<div class="collegetab-wrap">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="addmore">
				<a href="javascript:;" class="addmorecollegetab btn btn-primary"><i class="fa fa-plus"></i> Add More College Tab</a>
			</div>
		</div>
	</div>
</div>
<div class="collegetabadd" style="display:none;">
