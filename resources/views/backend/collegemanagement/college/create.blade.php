					...
					<div class="box">
						<div class="box-body">
							<div class="form-group">
								{!! Form::label('university','Institution Type',array('class'=>'col-sm-12 col-md-12 control-lable required')) !!}
							...
							<div class="form-group">
								{!! Form::label('title','College Name',array('class'=>'col-sm-12 col-md-12 control-lable required')) !!}
								<div class="col-sm-12 col-md-12">
							...
							<div class="box box-default">
								<div class="box-header with-border">
									...
									<div class="box-tools pull-right">
										...
										<div class="box-body upload-block">
											<div class="fimg" id="bgimg"></div>
											<p class="help-block">Max image size:1000x1000, less than 2MB</p>
											<span class="btn btn-default btn-file">
												<i class="fa fa-folder-open"></i>Upload Image
												<input type="file" name="upload[]" onchange="readfeatured10(this,'fimg');" accept="image/*" id="icon-upload" class="icon-upload">
											</span>
										</div>
									</div>
									<div class="box box-default">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="addmore">
												<a href="javascript:;" class="addmorecollege btn btn-primary"><i class="fa fa-plus"></i> Add Another College</a>
											</div>
										</div>
									</div>
								</div>
